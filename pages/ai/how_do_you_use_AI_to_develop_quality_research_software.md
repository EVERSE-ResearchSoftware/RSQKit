...
<!--
Content shifted out to:

  spectrum_practice_0_no_genai_usage.md
  spectrum_practice_10_open-ended_autonomous_agents.md
  spectrum_practice_1_conversational_interaction.md
  spectrum_practice_2_conversational_artefact_creation.md
  spectrum_practice_3_conversational_creation_with_zip_files_etc.md
  spectrum_practice_4_ide_autocomplete_and_inline_suggestions.md
  spectrum_practice_5_editor-integrated_local_assistant.md
  spectrum_practice_6_repository-aware_assistance.md
  spectrum_practice_7_constrained_local_tool-using_agents.md
  spectrum_practice_8_managed_or_cloud_coding_agents.md
  spectrum_practice_9_ci_pr_repository_agents.md
-->
