...
<div class="main_rdm mt-5 d-flex justify-content-center">
    ...
    viewBox="0 0 250.9 251" xml:space="preserve" height="24em">
        ...
        <text transform="matrix(1 0 0 1 16.4197 111.8653)" class="st1 st8 st9">Maintain</text>
        <text transform="matrix(1 0 0 1 76.3974 53.4992)" class="st1 st8 st9">Question</text>
        <text transform="matrix(1 0 0 1 19.2957 187.4998)" class="st1 st8 st9">Community feedback</text>
        <text transform="matrix(1 0 0 1 90.1372 234.4302)" class="st1 st8 st9">Deploy</text>
        <text transform="matrix(1 0 0 1 162.3473 208.6529)" class="st1 st8 st9">Publish</text>
        <text transform="matrix(1 0 0 1 159.7342 61.5168)" class="st1 st8 st9">Plan</text>
        <text transform="matrix(1 0 0 1 197.0817 128.9797)" class="st1 st8 st9">Develop</text>
    </svg>
</div>
