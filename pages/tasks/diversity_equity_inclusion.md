...
Research software is usually built inside academic structures, such as labs, grants, supervisory relationships, etc., which carry their own power imbalances on top of the usual open source ones.
...
- A broader, more diverse pool of attendees and contributors is widely cited as a driver of innovation in technical fields, since people with different backgrounds and experiences tend to bring forth different problems, use cases, and solutions; hybrid access is one practical lever for broadening that pool, though it is one factor among several rather than a guarantee of more innovative outcomes on its own.
