...
## Concrete sub-task/sub-problem 1, formulated as a question <!-- e.g.: "Why is it important to have a good README file?", it's ok to just address one task or problem on one task page  -->

### Description <!-- do not delete this heading and write your text below it -->

Short explanation of what the task or problem is about.

### Considerations <!-- do not delete this heading and write your text below it -->

Detail things to consider about this task or problem in order to be able to understand and/or find the right solution (e.g. cover benefits, audience etc)

A compact way of expressing these are in a bulleted list:
...
Describe the solution, this may include the use of specific tools or resources to solve the problem.

A compact way of expressing this are the use of bulleted lists (this is a suggestion only).

- Solution 1
  - Sub-point
- Solution 2

Make sure to add the tools and resources mentioned in the text in the _data/tool_and_resource_list.yml file; when referring to the tool on the page use the {% tool "<id>" %} format. 

Repeat the same structure for other sub-tasks and sub-problems you wish to mention on the page, as needed, e.g. as follows.

## Concrete sub-task/sub-problem 2, formulated as a question <!-- e.g.: "What key sections should a README include?" -->
...
<!--
You can use this section to list tool- or domain-specific (sub-)tasks here - list them in the page's *frontmatter* using parameter `child_pages` and then use the following text in the page by uncommenting it and using it directly in the page:
