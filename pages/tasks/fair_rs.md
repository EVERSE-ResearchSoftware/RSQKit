...
page_id: fair_rs
related_pages:
  tasks: [software_metadata, citing_software, licensing_software, software_documentation, documenting_code, archiving_software, structuring_software_projects, testing_software]
child_pages: []
...
- More broadly, follow best practices for software development, e.g. [structure your software][structuring_software_projects] using common patterns and use coding conventions to make your code readable and understandable by people
