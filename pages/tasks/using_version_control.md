...
* Establish a clear workflow:
   * Define a branching strategy appropriate to your project's size, something like [Git Flow](https://nvie.com/posts/a-successful-git-branching-model/) can help for larger projects, but a single main/master branch with short-lived feature/dev branches is often enough for smaller projects.
