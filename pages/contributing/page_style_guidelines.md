...
* [Research Cluster or Infrastructure page template](https://github.com/EVERSE-ResearchSoftware/RSQKit/blob/main/pages/research_clusters_and_infrastructures/TEMPLATE_research_cluster_or_infrastructure.md) for pages describing research clusters or infrastructures where software is a core part of activites. For an example - see ["ESCAPE - physics & astronomy"](https://everse.software/RSQKit/escape).
