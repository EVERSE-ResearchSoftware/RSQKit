...
For example, have a look at one of the [task pages](https://github.com/EVERSE-ResearchSoftware/RSQKit/blob/main/pages/your_tasks/) for how this syntax is used in practice.
