...
* **Workflow:** New developers, often interns or project partners, start by cloning the {% tool "github" %} repository. Work is commonly organised via GitHub Issues, and [GitHub Projects](https://github.com/features/issues) is being considered to localise the wider development strategy next to the code.
