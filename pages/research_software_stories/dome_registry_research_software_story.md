...
* **Core Stack:** [TypeScript](https://www.typescriptlang.org/), [Angular](https://angular.io/), [NestJS](https://nestjs.com/), [Node.js](https://nodejs.org/).
...
* **Workflow:** New developers, often interns or project partners, start by cloning the [GitHub repository](https://github.com/BioComputingUP/dome-registry). Work is commonly organised via GitHub Issues, and [GitHub Projects](https://github.com/features/issues) is being considered to localise the wider development strategy next to the code.
...
* **Obstacles:** The primary hurdle is the local environment setup. While documentation exists, the lack of full [Docker](https://www.docker.com/) containerisation means initial configuration of Node.js and database connections can be time-consuming. Work is underway to ensure Docker for both local use and full deployment to reduce this burden.
...
* **Productivity:** [GitHub Copilot](https://github.com/features/copilot) is used to assist with developer productivity and accelerate progress.
* **Containerisation:** Full containerisation with [Docker](https://www.docker.com/) is planned but not yet implemented. Currently, the environment is managed via detailed setup instructions and version-locked dependencies (`package.json`) to ensure consistency across local setups.
* **Future Plans:** [GitHub Actions](https://github.com/features/actions), automated dependency updates (to maintain security with minimal effort), and AI code generation are being considered to accelerate development progress, though risks regarding codebase stability and knowledge retention are acknowledged.
...
* **GitHub:** The [README](https://github.com/BioComputingUP/dome-registry) file covers basic deployment and setup, though improvements are planned.
